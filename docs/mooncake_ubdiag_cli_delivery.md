...
下方流程里的关键源文件可以从这里直接打开源码文件；行号仍在右侧列和段落标题中标注，便于进入源码后定位。

| 流程节点 | 源码入口 | 覆盖源码与行号 |
|---|---|---|
| 三层分发决策、L1/L2/L3 选择、CLI target 接入、RPM manifest 输出 | [mooncake-common/FindUbDiag.cmake](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake) | L13-L24、L26-L36、L81-L102、L137-L155、L160-L228、L233-L239 |
| Mooncake RPM 打包 UbDiag CLI、`libubdiag.so*`、配置文件 | [scripts/build_rpm.sh](file:///D:/Code/Mooncake/scripts/build_rpm.sh) | L80-L82、L184-L199、L201-L236、L237-L285、L428-L440 |
| UbDiag 子模块如何承接 shared SDK、P99、PerfLog、CSV CLI | [extern/ubdiag/CMakeLists.txt](file:///D:/Code/Mooncake/extern/ubdiag/CMakeLists.txt)<br>[extern/ubdiag/src/sdk/CMakeLists.txt](file:///D:/Code/Mooncake/extern/ubdiag/src/sdk/CMakeLists.txt)<br>[extern/ubdiag/src/cli/CMakeLists.txt](file:///D:/Code/Mooncake/extern/ubdiag/src/cli/CMakeLists.txt) | 顶层开关与 install、SDK `.so` target、CLI target |
| Mooncake 业务模块如何无感消费三层分发 target | [mooncake-store/src/CMakeLists.txt](file:///D:/Code/Mooncake/mooncake-store/src/CMakeLists.txt)<br>[mooncake-transfer-engine/src/CMakeLists.txt](file:///D:/Code/Mooncake/mooncake-transfer-engine/src/CMakeLists.txt)<br>[mooncake-integration/CMakeLists.txt](file:///D:/Code/Mooncake/mooncake-integration/CMakeLists.txt) | Store、Transfer Engine、Python store binding 链接 `UbDiag::ubdiag_lib` |
...
| 文件 | 作用 | 关键代码 |
|---|---|---|
| [mooncake-common/FindUbDiag.cmake](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake) | 三层分发主逻辑，新增 CLI 构建、L2 CLI 导入、RPM manifest 输出 | L13-L24 选项，L26-L36 manifest，L68-L158 L1，L160-L231 L2，L233-L239 L3 |
| [scripts/build_rpm.sh](file:///D:/Code/Mooncake/scripts/build_rpm.sh) | Mooncake RPM 打包，读取 manifest 后按 layer 打包 UbDiag CLI/lib/config | L184-L285 UbDiag 打包逻辑，L428-L440 `%files` |
| [mooncake-store/src/CMakeLists.txt](file:///D:/Code/Mooncake/mooncake-store/src/CMakeLists.txt) | Mooncake Store 链接 `UbDiag::ubdiag_lib` | L250-L252 |
| [mooncake-transfer-engine/src/CMakeLists.txt](file:///D:/Code/Mooncake/mooncake-transfer-engine/src/CMakeLists.txt) | Transfer Engine 链接 `UbDiag::ubdiag_lib` | L2、L50-L64 |
| [mooncake-integration/CMakeLists.txt](file:///D:/Code/Mooncake/mooncake-integration/CMakeLists.txt) | Python store 模块链接 `UbDiag::ubdiag_lib` | L104-L106 |

### 3.2 UbDiag submodule 侧承接能力

| 文件 | 作用 | 关键代码 |
|---|---|---|
| [extern/ubdiag/CMakeLists.txt](file:///D:/Code/Mooncake/extern/ubdiag/CMakeLists.txt) | UbDiag 顶层开关、install 规则 | L11-L18 P99/PerfLog/shared 选项，L44-L49 宏定义，L179-L187 CLI/config install |
| [extern/ubdiag/src/sdk/CMakeLists.txt](file:///D:/Code/Mooncake/extern/ubdiag/src/sdk/CMakeLists.txt) | SDK 库构建，`UBDIAG_BUILD_SHARED` 控制 `.so` | L9-L20 |
| [extern/ubdiag/src/cli/CMakeLists.txt](file:///D:/Code/Mooncake/extern/ubdiag/src/cli/CMakeLists.txt) | CLI target，包含 `csv_writer.cpp` | L1-L16 |
| [extern/ubdiag/src/cli/cli_config.cpp](file:///D:/Code/Mooncake/extern/ubdiag/src/cli/cli_config.cpp) | CLI 参数解析，支持 `--perflog`、`--csv` | L458-L464、L768-L780 |
| [extern/ubdiag/src/cli/display_engine.cpp](file:///D:/Code/Mooncake/extern/ubdiag/src/cli/display_engine.cpp) | CLI 展示层，P99/P999/P9999 和 CSV 输出承接 | 多处 `UBDIAG_ENABLE_PERCENTILE` 和 CSV writer 调用 |
...
> 源码：[FindUbDiag.cmake#L13-L24](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L13-L24)
...
> 源码：[FindUbDiag.cmake#L26-L36](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L26-L36)
...
> 源码：[FindUbDiag.cmake#L68](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L68)
...
> 源码：[FindUbDiag.cmake#L69-L84](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L69-L84)、[FindUbDiag.cmake#L104-L117](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L104-L117)
...
> 源码：[FindUbDiag.cmake#L85-L99](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L85-L99)
...
> 源码：[extern/ubdiag/CMakeLists.txt#L11-L18](file:///D:/Code/Mooncake/extern/ubdiag/CMakeLists.txt#L11-L18)、[extern/ubdiag/CMakeLists.txt#L44-L49](file:///D:/Code/Mooncake/extern/ubdiag/CMakeLists.txt#L44-L49)
...
> 源码：[FindUbDiag.cmake#L101-L102](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L101-L102)
...
> 源码：[FindUbDiag.cmake#L119-L141](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L119-L141)
...
> 源码：[FindUbDiag.cmake#L137-L144](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L137-L144)
...
> 源码：[extern/ubdiag/src/cli/CMakeLists.txt#L1-L16](file:///D:/Code/Mooncake/extern/ubdiag/src/cli/CMakeLists.txt#L1-L16)
...
> 源码：[FindUbDiag.cmake#L149-L155](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L149-L155)
...
> 源码：[FindUbDiag.cmake#L160-L170](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L160-L170)
...
> 源码：[FindUbDiag.cmake#L38-L63](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L38-L63)、[FindUbDiag.cmake#L171-L180](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L171-L180)
...
> 源码：[FindUbDiag.cmake#L187-L203](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L187-L203)
...
> 源码：[FindUbDiag.cmake#L211-L228](file:///D:/Code/Mooncake/mooncake-common/FindUbDiag.cmake#L211-L228)
...
> 源码：[scripts/build_rpm.sh#L80-L82](file:///D:/Code/Mooncake/scripts/build_rpm.sh#L80-L82)
...
> 源码：[scripts/build_rpm.sh#L184-L199](file:///D:/Code/Mooncake/scripts/build_rpm.sh#L184-L199)
...
> 源码：[scripts/build_rpm.sh#L201-L236](file:///D:/Code/Mooncake/scripts/build_rpm.sh#L201-L236)
...
> 源码：[scripts/build_rpm.sh#L237-L282](file:///D:/Code/Mooncake/scripts/build_rpm.sh#L237-L282)
...
> 源码：[scripts/build_rpm.sh#L428-L440](file:///D:/Code/Mooncake/scripts/build_rpm.sh#L428-L440)
...
> 源码：[mooncake-store/src/CMakeLists.txt#L250-L252](file:///D:/Code/Mooncake/mooncake-store/src/CMakeLists.txt#L250-L252)
...
> 源码：[mooncake-transfer-engine/src/CMakeLists.txt#L2](file:///D:/Code/Mooncake/mooncake-transfer-engine/src/CMakeLists.txt#L2)、[mooncake-transfer-engine/src/CMakeLists.txt#L50-L64](file:///D:/Code/Mooncake/mooncake-transfer-engine/src/CMakeLists.txt#L50-L64)
...
> 源码：[mooncake-integration/CMakeLists.txt#L104-L106](file:///D:/Code/Mooncake/mooncake-integration/CMakeLists.txt#L104-L106)
