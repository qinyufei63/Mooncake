...
echo "WRITE BENCHMARK: bench=${BENCH} protocol=${PROTOCOL} host=${LOCAL_HOSTNAME} keys=${NUM_KEYS}"
set +e
...
grep -E '(succeeded|failed|complete|Written|All segments|Total ops|Throughput|Ops/sec|Wall time)' \
