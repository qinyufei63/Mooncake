...
# BENCH=/usr/bin/stress_cluster_bench
BENCH=./z00926396/Mooncake/build/mooncake-store/benchmarks/stress_cluster_bench
$BENCH \
        --metadata-server='http://141.61.84.245:8018/metadata' \
        --master-server='141.61.84.245:50058' \
        --local-hostname=$MC_TCP_BIND_ADDRESS \
        --master_admin_port=9008 \
